# 🎨 Color, Symbol, Image (CSI) Worksheet
...
- **🔤 한글 텍스트 완벽 지원**: 한글 입력 시 글자 잘림 없음 (v3.0 개선사항)
...
### v3.0 (2025.06.14)
- 🔤 **한글 텍스트 잘림 문제 해결**
  - 탐구 주제 입력란 line-height 2.0으로 증가
  - 모든 입력 필드 padding 증가 (0.875rem)
  - 최소 높이(min-height) 설정으로 안정성 향상
- 📐 **레이아웃 개선**
  - 입력 필드 기본 line-height 1.8로 통일
  - 인쇄 모드에서도 한글 완벽 지원
